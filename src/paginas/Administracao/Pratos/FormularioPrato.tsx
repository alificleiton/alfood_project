...
const FormularioPrato = () =>{
    ...
    const [descricaoPrato,setDescricao] = useState('')
                    ...
                    <Paper sx={{ p: 2}}>
                        <Box sx={{display:'flex', flexDirection:'column', alignItems:'center', flexGrow: 1}}>
                            ...
                            <Box component="form" sx={{ width:'100%'}} onSubmit={aoSubmeterForm}>
                                ...
                                label="Nome do Prato" variant="standard" fullWidth required margin="dense"/>
                                <TextField value={descricaoPrato} 
                                onChange={evento => setDescricao(evento.target.value)} 
                                label="Descrição do Prato" variant="standard" fullWidth required margin="dense" />
